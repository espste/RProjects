...
library(DT)
library(scales)
setwd('/Users/espst/Documents/RProjects/Uber Data Analysis')
...
# combine to a data frame "data_2014"
...
data_2014$year <- data_2014$day <- factor(year(data_2014$Date.Time))
...
# PLOTTING THE TIPS BY THE HOURS IN A DAY
...
# PLOTTING DATA BY TRIPS EVERY DAY OF THE MONTH
